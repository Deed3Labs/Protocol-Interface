  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {filteredDeeds.length === 0 ? (
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertTitle>No Deeds Found</AlertTitle>
          <AlertDescription>
            You don't have any deeds yet. Visit the mint page to create one.
          </AlertDescription>
        </Alert>
      ) : (
            ...
            <Card key={deed.id} className={viewMode === 'list' ? 'flex' : ''}>
              ...
              <CardContent className={viewMode === 'list' ? 'w-2/3' : ''}>
                <div className="space-y-2">
                  <div>
                    <span className="font-medium">Type:</span> {deed.traits.propertyType}
                  </div>
                  <div>
