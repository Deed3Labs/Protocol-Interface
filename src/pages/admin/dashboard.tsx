      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <a href="/admin/transactions" className="font-medium text-green-600 hover:text-green-500">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="flex items-baseline">
                      <div className="text-2xl font-semibold text-gray-900">0 ETH</div>
                      <div className="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                        <svg className="self-center flex-shrink-0 h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clipRule="evenodd" />
                        </svg>
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <a href="/admin/value" className="font-medium text-purple-600 hover:text-purple-500">
